      ...
      <div className="container max-w-5xl mx-auto py-8 px-4 space-y-5">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Linked accounts, budgets, and the subscription audit. Connect a bank to see automatic transactions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <StatCard
            ...
            sub={summary ? `${summary.accounts.length} account${summary.accounts.length === 1 ? '' : 's'}` : ''}
          />
          <StatCard
            label="Spent (30d)"
          ...
          <StatCard
            ...
            sub={summary ? `Net ${summary.totals.net_30d >= 0 ? '+' : ''}${summary.totals.net_30d.toFixed(2)}` : ''}
            tone="positive"
          />
        </div>
