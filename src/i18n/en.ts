...
const en: Record<string, string> = {
  ...
  'content.calendarEmpty': "Nothing scheduled yet. Hit Schedule on an idea to drop it here — it'll also show up in your main Calendar.",
  ...
  'content.toast.generatedSuffix': 'fresh ideas generated',
