...
export const TOOL_REGISTRY: readonly ToolDefinition[] = [
  ...
  tool(
    ...
    "confirm",
    true,
    "Move many tasks or events at once.",
  ),
  tool(
    "bulk_delete_events",
    "calendar",
  ...
  tool(
    ...
    "auto",
    true,
    "Attach a completion note to a task.",
  ),
  tool(
    "task_duplicate",
    "productivity",
  ...
  tool(
    ...
    "confirm",
    false,
    "Send a Telegram family message.",
    {
      outwardFacing: true,
    },
  ),
  ...
  tool(
    ...
    "confirm",
    false,
    "Compute or discuss financial obligations.",
  ),
  tool(
    "meds",
    "health",
  ...
  tool(
    ...
    "auto",
    true,
    "Log mood, energy, stress, or wellbeing.",
  ),
  tool(
    "period_log",
    "health",
  ...
  tool(
    ...
    "auto",
    false,
    "Resolve currency conversion or formatting.",
  ),
  tool(
    "presence",
    "system",
...
function approvalFor(
  ...
  if (toolDef.destructiveOps?.includes(operation) || DESTRUCTIVE_OPS.has(operation))
    return "confirm";
