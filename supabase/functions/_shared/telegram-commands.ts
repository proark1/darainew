...
export const TELEGRAM_COMMANDS = [
  ...
  { command: "listmeetings", description: "📅 Next meetings, numbered — edit one by its number" },
...
export const TELEGRAM_GROUP_COMMANDS = [
  ...
  { command: "listmeetings", description: "Next meetings, numbered" },
...
export const TELEGRAM_GROUP_COMMANDS_DE = [
  ...
  { command: "listmeetings", description: "Naechste Termine, nummeriert" },
